...
public:
  ...
  typedef DisplayHelloTransformIOFactory      Self;
  ...
  itkTypeMacro(DisplayHelloTransformIOFactory, ObjectFactoryBase);

  /** Register one factory of this type  */
  static void RegisterOneFactory(void)
  {
    DisplayHelloTransformIOFactory::Pointer factory = DisplayHelloTransformIOFactory::New();

    ObjectFactoryBase::RegisterFactoryInternal(factory);
  }

protected:
  DisplayHelloTransformIOFactory();
  ~DisplayHelloTransformIOFactory();
  virtual void PrintSelf(std::ostream & os, Indent indent) const ITK_OVERRIDE;

private:
  DisplayHelloTransformIOFactory(const Self &); //purposely not implemented
